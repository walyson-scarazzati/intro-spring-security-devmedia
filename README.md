- code made during the course Primeiros passos com Spring Security from https://www.devmedia.com.br/ To run, just right-click on the project run as > Spring Boot app.
